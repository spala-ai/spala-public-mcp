...
test('production app.js launcher serves rebuilt dist and enforces MCP and shared OAuth rate limits', async () => {
  ...
  const child = spawn(process.execPath, ['app.js'], {
    ...
    env: {
      ...
      PUBLIC_OAUTH_ENCRYPTION_SECRET: 'dist-launcher-public-oauth-encryption-secret-32-bytes',
      PUBLIC_OAUTH_REPLAY_STATE_PATH: replayStatePath,
      PUBLIC_MCP_PLATFORM_SERVICE_SECRET: 'dist-launcher-platform-service-secret-value-32-bytes',
